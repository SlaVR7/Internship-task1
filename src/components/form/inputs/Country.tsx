...
import { ICountriesContainer } from '../../../lib/interfaces.ts';
import { filterCountries } from '../../../services/filterCountries.ts';

export function Country({ errors, setValue, register, countries }: ICountriesContainer) {
      ...
      <div>
        ...
        <input
          ...
          onChange={(event) => {
            ...
            const inputValueCapitalize = inputValue.slice(0, 1).toUpperCase() + inputValue.slice(1);
